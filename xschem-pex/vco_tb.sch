...
.option klu
.control
	echo 'icont frequency vc vb' > vco_tb.data
	...
	echo $&icont_avg $&frequency $&vc_avg $&vb_avg >> vco_tb.data
.endc
"}
...
C {devices/lab_wire.sym} -250 -910 0 0 {name=p15 sig_type=std_logic lab=VDD}
...
only_toplevel=false
value="
.lib /foss/pdks/sky130A/libs.tech/combined/sky130.lib.spice __CORNER__

.temp __TEMPERATURE__
"}
C {vco.sym} -60 -690 0 0 {name=x1}
C {devices/lab_wire.sym} -150 -630 3 0 {name=p8 sig_type=std_logic lab=Vp0}
C {devices/lab_wire.sym} -130 -630 3 0 {name=p9 sig_type=std_logic lab=Vp1}
C {devices/lab_wire.sym} -110 -630 3 0 {name=p10 sig_type=std_logic lab=Vp2}
C {devices/lab_wire.sym} -90 -630 3 0 {name=p12 sig_type=std_logic lab=Vp3}
C {devices/lab_wire.sym} -30 -630 3 0 {name=p14 sig_type=std_logic lab=Vn0}
C {devices/lab_wire.sym} -10 -630 3 0 {name=p16 sig_type=std_logic lab=Vn1}
C {devices/lab_wire.sym} 10 -630 3 0 {name=p17 sig_type=std_logic lab=Vn2}
C {devices/lab_wire.sym} 30 -630 3 0 {name=p18 sig_type=std_logic lab=Vn3}
