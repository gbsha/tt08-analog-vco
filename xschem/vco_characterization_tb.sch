...
.option klu
.control
	echo 'icont period vc vb' > vco_characterization_tt_0.txt
	let icont_val = 0.025e-3
	let icont_step = 0.025e-3

	while icont_val <= 0.25e-3

		alterparam icont = $&icont_val
		...
		echo $&icont_val $&PERIOD $&vc_avg $&vb_avg >> vco_characterization_tt_0.txt 
		
		let icont_val = icont_val + icont_step
	end
.endc
"}
